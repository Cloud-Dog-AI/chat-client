...
def _api_server(env_file):
    overrides = {
        ...
        "CLOUD_DOG__LLM__RESPONSE__MARKER_VALUE": "FORMAT_OK",
        ...
        "CLOUD_DOG__LLM__RESPONSE__SHOW_THINKING": "true",
...
@pytest.mark.asyncio
async def test_st1_8_response_formatting_thinking(env_file):
    cfg = ConfigManager(env_file=env_file)
    ...
    async with __import__("httpx").AsyncClient(
        ...
        resp = await client.post("/sessions", json={"metadata": {"suite": "st1.8"}})
